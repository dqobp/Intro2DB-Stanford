...
doc("BookstoreQ.xml")/Bookstore/Book/@ISBN //will get error, using data()
...
doc("BookstoreQ.xml")/Bookstore/Book[@Price < 90 and
              ...
              Authors/Author/First_Name="Jeffrey"]/Title
              //not what we expect, We have one author whose last name is Widom and another  author whose first name is Jeffrey.
