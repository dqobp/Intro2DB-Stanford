...
<!--*****************************************************************
     ...
     List of book and magazine titles (change tags)
******************************************************************-->
...
<!--*****************************************************************
     ...
     Note unwanted concatentated text (When you have elements in your database that aren't matched by any template, what XSLT will do is actually return the concatenation of the string leaf or text leaf values of those elements.)
******************************************************************-->
